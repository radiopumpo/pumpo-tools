...
const SMC_DATA = {
  ...
  sessions: {
    asian: {
      ...
      role: 'Range formation. Sets the liquidity pools that London and NY will target.',
      characteristics: [
  ...
  concepts: [
    ...
    // ─ MODULE 1: MARKET STRUCTURE ─
    {
      ...
      rules: [
        ...
        'Change of Character (ChoCH): first break against the trend — potential reversal signal',
      ...
      key_levels: ['swing_high', 'swing_low', 'BOS_level', 'ChoCH_level'],
    ...
    // ─ MODULE 2: LIQUIDITY ─
    {
      ...
      rules: [
        ...
        'A liquidity raid without a structural shift is just a wick — wait for ChoCH confirmation',
      ],
      visual_type: 'annotated_chart',
    ...
    // ─ MODULE 3: FAIR VALUE GAPS ─
    {
      ...
      rules: [
        ...
        'Price typically returns to fill 50% of the FVG — this is the optimal entry zone',
    ...
    // ─ MODULE 5: SESSIONS & KILLZONES ─
    {
      ...
      rules: [
        'Asian session (23:00–08:00 UTC): range formation, do not trade — wait for the range',
    ...
    // ─ MODULE 6: TOP-DOWN ANALYSIS ─
    {
      ...
      rules: [
        ...
        '4H: refine the daily array. Where is the 4H structure? Is there a 4H ChoCH in line with bias?',
        '1H: identify the entry array. OB or FVG that aligns with higher timeframe bias.',
        '15M: the trigger timeframe. Look for ChoCH on 15M after liquidity raid for entry confirmation.',
  ...
  engine_weights: {
    ...
    liquidity_raid: { max: 20, label: 'Liquidity Raid Confirmed' },
    choch:          { max: 15, label: 'ChoCH Confirmed' },
